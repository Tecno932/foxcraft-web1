...
{!showSettings ? ( <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between"> <div className="max-w-3xl"> <h2 className="font-heading text-lg font-semibold">
Tu privacidad importa </h2>

          <p className="mt-2 text-sm leading-6 text-muted">
            Usamos tecnologías necesarias para mantener FoxCraft
            funcionando y tecnologías opcionales para conocer cómo se
            utiliza el sitio y mostrar publicidad. Podés aceptar todo o
